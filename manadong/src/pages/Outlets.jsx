  ...
  return (
    <div class="OrderPage overflow-x-hidden h-screen w-screen ">
      <div className="flex flex-col items-start mx-20">
        ...
        <div className="flex flex-row my-10 w-full gap-10">
          <div className="flex flex-col items-start justify-center  gap-5 w-1/2">
          ...
          <img src="/asset/png/percumian.png" className="w-1/2" />
        </div>
      </div>
    </div>
  );
