...
function App() {
  ...
  return (
    <div class="LandingPage overflow-x-hidden">
      <Navbar />
      <div class="md:flex md:flex-row h-full pb-20 md:pb-0 md:h-screen w-screen bg-[#F6D5D3] md:bg-transparent">
        <div class="flex flex-col items-center md:items-start justify-center md:bg-[#F6D5D3] md:w-1/3">
          <div class="flex flex-col items-start mx-40 my-20 md:my-0">
          ...
          <div class="flex flex-col items-center md:items-start mt-10 mx-40 gap-3">
      ...
      <div class="flex flex-col h-screen w-screen md:mt-96">
        <div class=" bg-[#F6D5D3] w-full h-1/2 items-center justify-start flex flex-col md:flex-row">
          <div class="flex flex-col items-center my-10 md:my-0 md:items-start md:mx-40 ">
            <p class="text-3xl font-semibold text-[#004688]">Promotion</p>
            <div class="bg-[#D72F24] w-12 h-1"></div>
          </div>
          <div class="flex flex-row gap-2 md:gap-24 md:mx-40">
            <Promotion
        ...
        <div class=" bg-[#CBD9E6] w-full h-1/2 justify-start flex flex-col">
          <div class="flex flex-col items-center md:items-start mx-40 my-10">
            <p class="text-3xl font-semibold text-[#004688]">Reviews</p>
            <div class="bg-[#D72F24] w-12 h-1"></div>
          </div>
          <div class="flex flex-row gap-2 md:gap-10 md:mx-40">
            <Review
              name="Jennifer"
      ...
      <div class="flex flex-col w-screen h-screen gap-10">
        <div class="flex flex-col items-center md:items-start mx-40 my-0 mt-10 md:mt-20 md:my-10">
          <p class="text-3xl font-semibold text-[#004688]">Locations</p>
          <div class="bg-[#D72F24] w-12 h-1"></div>
        </div>

        <div class="flex flex-row gap-2 md:gap-10 items-start md:mx-40">
          <Location
